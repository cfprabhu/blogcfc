...
<cfmodule template="../tags/adminlayout.cfm" title="Entry Editor">
	...
	<cfif not structKeyExists(form, "preview")>
		...
		<!--- tabs --->
		<cfoutput>
		<form action="entry.cfm?id=#url.id#" method="post" enctype="multipart/form-data" name="editForm" id="editForm" class="inlineLabels" role="form">

		<div id="entrytabs">

			<ul class="nav nav-tabs">
				<li class="active"><a href="##tab-main" data-toggle="tab" data-value="##main"><span>Main</span></a></li>
				<li><a href="##tab-additional" data-toggle="tab" data-value="##additional"><span>Additional Settings</span></a></li>
				<li><a href="##tab-related" data-toggle="tab" data-value="##related"><span>Related Entries</span></a></li>				
				<cfif url.id neq 0>
					<li data-toggle="tab"><a href="##comments"><span>Comments</span></a></li>
				</cfif>
			</ul>
		<div class="tab-content" id="tabs">
		<div class="tab-pane active" id="tab-main">	<br>
		...
		<div class="ctrlHolder form-group">
			...
			<input type="text" name="title" id="title" value="#htmlEditFormat(form.title)#" maxlength="100" class="form-control">
		</div>
		</fieldset>
		...
		<div class="ctrlHolder form-group">
			...
			<br />
			<a href="#application.rooturl#/admin/imgwin.cfm" target="_new" id="uploadImage">[Upload and Insert Image]</a> / <a href='#application.rooturl#/admin/imgbrowse.cfm' target="_new" id="browseImage">[Browse Image Library]</a>
		</div>
		</fieldset>
		<fieldset class="inlineLabels">		
		<div class="ctrlHolder form-group">
			<label for="categories">Categories: </label>
			<cfif allCats.recordCount><select class="form-control" name="categories" id="categories" multiple="multiple" size="4">
				<cfloop query="allCats">
		...
		<div class="ctrlHolder form-group">
			...
			<input type="text" name="newcategory" id="newcategory" value="#htmlEditFormat(form.newcategory)#" class="form-control">
		</div>
		</fieldset>
		</cfif>
		<fieldset class="inlineLabels">		
		...
		<div class="ctrlHolder form-group">
			...
			<input type="text" class="form-control" name="manualenclosure" id="manualenclosure" class="form-control">
		</div>		
		</fieldset>
		...
		<div class="tab-pane" id="tab-additional">	
			<fieldset class="inlineLabels"><br>
			<div class="ctrlHolder form-group">
				<label for="posted">Posted: </label>
				<input type="text" class="form-control" name="posted" id="posted" value="#form.posted#" maxlength="100">
			</div>
			<div class="ctrlHolder form-group">
				<label for="alias">Alias: </label>
				<input type="text" name="alias" id="alias" value="#form.alias#" maxlength="100" class="form-control">
			</div>
			<div class="ctrlHolder form-group">
				<label for="allowcomments">Allow Comments: </label>
				<select name="allowcomments" class="form-control" id="allowcomments">
			...
			<div class="ctrlHolder form-group">
				...
				<input type="text" name="subtitle" id="subtitle" value="#form.subtitle#" maxlength="100" class="form-control">
			</div>
			<div class="ctrlHolder form-group">
				<label for="keywords">iTunes Keywords: </label>
				<input type="text" name="keywords" id="keywords" value="#form.keywords#" maxlength="100" class="form-control">
			</div>
			<div class="ctrlHolder form-group">
				<label for="keywords">iTunes Keywords: </label>
				<input type="text" name="keywords" id="keywords" value="#form.keywords#" maxlength="100" class="form-control">
			...
			<div class="ctrlHolder form-group">
				...
				<input type="text" name="duration" id="duration" value="#form.duration#" maxlength="10" class="form-control">
			</div>
			</fieldset>
		</div>
		...
		<div class="tab-pane" id="tab-related">	
			...
			<div class="ctrlHolder form-group">
				...
				<input type="text" name="titlefilter" id="titlefilter" maxlength="100" class="form-control">
			</div>
			<div class="ctrlHolder form-group">
				<label for="categories_dropdown">Filter by Category: </label>
				<select id="categories_dropdown" class="form-control" size="4">
				<cfloop query="allCats">
			...
			<div class="ctrlHolder form-group">
				...
				<select id="entries_dropdown" size="4" class="form-control" style="cursor:pointer;">
				</select>
			</div>
			<div class="ctrlHolder form-group">
				...
				<label for="cbRelatedEntries">Current Related Entries: (clicking removes an entry)</label>
					<select id="cbRelatedEntries" name="cbRelatedEntries" multiple="multiple" size="4"  class="form-control" style="cursor:pointer;" >
		...
		<p>
		<input type="submit" class="btn btn-danger" name="cancel" value="Cancel" onClick="return confirm('Are you sure you want to cancel this entry?')"> <input type="submit" class="btn btn-primary" name="preview" value="Preview"> <input type="submit" class="btn btn-primary" name="save" value="Save">
		</p>
